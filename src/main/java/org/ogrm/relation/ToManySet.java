...
public class ToManySet<E> implements Set<E> {

	private RelationManager helper;

	private PersistenceContext context;

	public ToManySet(PersistenceContext context, Node node, String name) {
		this.context = context;
		this.helper = new RelationManager( name, node,Direction.OUTGOING );
	}
