...
import org.ogrm.relation.FromOneRel;
import org.ogrm.relation.ToOneRel;

public class OneRelSynchronizer implements Synchronizer<Node> {
	...
	public OneRelSynchronizer(Property property, PersistenceContext context, Direction direction) {
	...
	public void onLoad( Object object, Node container ) {
		...
		if (direction.equals( Direction.OUTGOING ))
			set = new ToOneRel<Object>( context, (Node) container, property.getName() );
		else
			set = new FromOneRel<Object>( context, (Node) container, property.getName() );
